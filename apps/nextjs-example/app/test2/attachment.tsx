			...
			>
				<AttachmentPreviewDialog>
					<TooltipTrigger asChild>
						<div
							className={
								"size-14 border-foreground/20 cursor-pointer overflow-hidden rounded-[14px] border bg-muted transition-opacity hover:opacity-75"
							}
							role="button"
							id="attachment-tile"
				...
				{!noRemoveButton && <AttachmentRemove />}
			</AttachmentPrimitive.Root>
