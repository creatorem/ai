...
type BaseComponentPropsWithChildren = BaseComponentProps &
  React.PropsWithChildren;

type TextareaStyle = Omit<
  NonNullable<React.CSSProperties>,
  "maxHeight" | "minHeight"
> & {
  height?: number;
};
...
> &
  BaseComponentPropsWithChildren & { onClick?: (e: Event) => void };
...
export interface RuntimeComponents {
  ...
  CodeBlock: ComponentType<
    BaseComponentProps & { language?: string; value: string }
  >;
  ...
  Separator: ComponentType<
    BaseComponentProps & { orientation?: "horizontal" | "vertical" }
  >;
