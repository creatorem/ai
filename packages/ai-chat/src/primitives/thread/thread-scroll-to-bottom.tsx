...
import { ActionButtonElement } from "../../utils/create-action-button";
...
export const ThreadPrimitiveShowScrollToBottom: React.FC<{
...
>(
  (
    { behavior = "smooth", disabled, onClick, noAutoHide = false, ...props },
    forwardedRef,
  ) => {
    const {
      components: { Button },
